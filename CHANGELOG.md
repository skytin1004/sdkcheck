...
- Docker-first Co-op Translator dogfood recipe.
- Local backend for development.
- Deterministic fake OpenAI-compatible endpoint for dogfood runs.
...
- Installation documentation for release archives, Git installs, and local builds.
- Static `sdkcheck.com` landing page and GitHub Pages deployment workflow.
- First open-source project files: contributing guide, security policy, code of conduct, CI, issue templates, and release checklist.
